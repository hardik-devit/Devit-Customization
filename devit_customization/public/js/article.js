frappe.ui.form.on('Item', {
    refresh: function(frm) {
        ...
        frm.toggle_display(['netto_weight_in_kg', 'brutto_weight_in_kg', 'baked_weight_in_kg', 'nr_of_items_on_plate', 'plates_per_trolley', 'retours', 'retourenartikel', 'empty_retours', 'retourenanteilsberechnung'], ["Finished good", "Fertigware", "Beendet gut", "Fertigwaren"].includes(frm.doc.article_type));
        ...
        frm.toggle_display(['purchasing_production', 'production_costs', 'replacement_in_hours'], ["Finished good", "Beendet gut", "Fertigware", "Fertigwaren"].includes(frm.doc.article_type) || ["Dough", "Teig"].includes(frm.doc.article_type));
        frm.toggle_display(['average_nutritions_per_slice_', 'minerals'], !["Raw material", "Rohmaterial", "Rohstoffe"].includes(frm.doc.article_type))
